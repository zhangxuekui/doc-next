        ...
        if ((isDraggingLeft || isDraggingRight) && rulerRef.current) {
            ...
            if (container) {
                ...
                if (isDraggingLeft) {
                    ...
                    console.log("constrainedRightPosition:", constrainedRightPosition, "newRightPosition:", newRightPosition, "maxRightPosition:", maxRightPosition, "rawPosition:", rawPosition, "rightMargin:", rightMargin, "leftMargin:", leftMargin, "relativeX:", relativeX);
